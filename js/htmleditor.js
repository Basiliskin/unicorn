(function(addon) {
    ...
    UI.component('htmleditor', {
        ...
        defaults: {
            ...
            toolbar      : EditorConfig ? EditorConfig.defaults.toolbar : [ 'bold', 'italic', 'strike', 'link', 'image', 'blockquote', 'listUl', 'listOl'],
            lblSave   : 'Save',
            lblLoad   : 'Load',
            lblPreview   : 'Preview',
            lblCodeview  : 'HTML',
        ...
        init: function() {
			...
			var tpl = Tpl.before.join('');
			if(this.options.show_button)
				tpl += this.options.show_button().join('');
            ...
            tpl = tpl.replace(/\{:lblSave}/g, '' /* this.options.lblSave */);
            tpl = tpl.replace(/\{:lblLoad}/g, '' /* this.options.lblLoad */);
    ...
    UI.plugin('htmleditor', 'base', {
        ...
        init: function(editor) {
			...
			if(EditorConfig){
				EditorConfig.init(editor,addAction);
			}else{
				editor.addButtons({
					fullscreen: {
						title  : 'Fullscreen',
						label  : '<i class="uk-icon-hover uk-icon-small uk-icon-expand"></i>'
					},
					bold : {
						title  : 'Bold',
						label  : '<i class="uk-icon-hover uk-icon-small uk-icon-bold"></i>'
					},
					italic : {
						title  : 'Italic',
						label  : '<i class="uk-icon-hover uk-icon-small uk-icon-italic"></i>'
					},
					strike : {
						title  : 'Strikethrough',
						label  : '<i class="uk-icon-hover uk-icon-small uk-icon-strikethrough"></i>'
					},
					blockquote : {
						title  : 'Blockquote',
						label  : '<i class="uk-icon-hover uk-icon-small uk-icon-quote-right"></i>'
					},
					link : {
						title  : 'Link',
						label  : '<i class="uk-icon-hover uk-icon-small uk-icon-link"></i>'
					},
					image : {
						title  : 'Image',
						label  : '<i class="uk-icon-hover uk-icon-small uk-icon-picture-o"></i>'
					},
					listUl : {
						title  : 'Unordered List',
						label  : '<i class="uk-icon-hover uk-icon-small uk-icon-list-ul"></i>'
					},
					listOl : {
						title  : 'Ordered List',
						label  : '<i class="uk-icon-hover uk-icon-small uk-icon-list-ol"></i>' 
					}
